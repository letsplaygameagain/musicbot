...
async def init():
    ...
    for all_module in ALL_MODULES:
        importlib.import_module("JooxMusic.plugins" + all_module)
    LOGGER("Jooxmusic.plugins").info(
...
if __name__ == "__main__":
    ...
    LOGGER("JooxMusic").info("Stopping Joox Music Bot! GoodBye")
